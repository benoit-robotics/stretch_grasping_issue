...
def generate_launch_description():
    ...
    stretch_grasping_path = get_package_share_path('stretch_grasping_issue')
    ...
    grasp_server_launch = PythonLaunchDescriptionSource(str(stretch_grasping_path / 'launch/stretch_grasp.launch.py'))
    grasp_server = IncludeLaunchDescription(grasp_server_launch,
                                                 launch_arguments=move_group_launch_args.items())
    ld.add_action(grasp_server)
